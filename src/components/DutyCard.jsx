...
const DutyCard = ({ icon, title, description }) => {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-primary-500/20 hover:border-primary-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group w-full h-full">
