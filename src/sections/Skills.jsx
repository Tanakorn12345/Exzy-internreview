        ...
        <div className="flex flex-col md:flex-row gap-12">
          <div className="w-full md:w-1/3">
            ...
            <p className="text-base text-dark-500/80 mb-6 leading-relaxed">
             การฝึกงานที่ Exzy ครั้งนี้ ถือว่าเปิดโลกการทำงานจริงให้เรามากเลยครับ การได้ลุยโปรเจกต์และลงพื้นที่หน้างาน ช่วยอัปเกรดตัวเราแบบรอบด้าน และยังทำให้ได้สกิลใหม่ ๆ ติดตัวกลับมาเยอะเลยครับ
            </p>
          </div>
