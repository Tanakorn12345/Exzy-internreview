...
const Culture = () => {
  ...
  const cultureData = [
    ...
    },
    {
      ...
      description: "อีกหนึ่งสิ่งที่ประทับใจคือ เมื่อสิ้นสุดการฝึกงาน พี่ ๆ ในทีมได้จัดเลี้ยงอำลาให้กับนักศึกษาฝึกงานทุกคน ถือเป็นธรรมเนียมที่อบอุ่นของบริษัท ทำให้รู้สึกได้รับการต้อนรับและเป็นส่วนหนึ่งของทีมตั้งแต่วันแรกจนถึงวันสุดท้ายของการฝึกงาน",
      gridClass: "col-span-1 md:col-span-1"
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px] md:auto-rows-[320px]">
          ...
          <div className="col-span-1 md:col-span-2 h-full bg-dark-500 rounded-2xl shadow-md overflow-hidden p-8 flex flex-col justify-center relative">
            ...
            <p className="text-primary-100 text-base leading-relaxed z-10 overflow-y-auto pr-2 custom-scrollbar">
             รู้สึกประทับใจบรรยากาศการทำงานที่เป็นกันเอง รวมถึงพี่เลี้ยงและทีมที่คอยให้คำแนะนำอย่างใกล้ชิด ทำให้เข้าใจการทำงานได้ง่ายและได้เรียนรู้จากการปฏิบัติงานจริง ทั้งการแก้ไขปัญหาหน้างาน การทำงานเป็นทีม และการรับมือกับสถานการณ์ต่าง ๆ อีกทั้งยังมีบรรยากาศการทำงานที่ผ่อนคลายและเป็นมิตร ทำให้การฝึกงานเป็นประสบการณ์ที่สนุกและได้รับความรู้อย่างเต็มที่
            </p>
          </div>
        </div>
        <CultureModal 
