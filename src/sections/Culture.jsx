  ...
  const cultureData = [
    {
      ...
      description: "เป็นบรรยากาศที่ผมเข้ามาทำงานในทุกวัน เวลาไม่ได้ออกไป on site service ครับ โดยที่พี่ๆจะคุยกันทุกเช้า เรียกว่า Stand-up Meeting เพื่ออัปเดตงานที่ทำอยู่และที่จะทำในวันนี้ หรือแลกเปลี่ยนความคิดเห็นกันครับ ซึ่งก็จะมีการอัพเดทงานที่ทำในวันนี้ของผมด้วยครับ",
    ...
    },
    {
      ...
      description: "เป็นการดูระบบการจัดการ minew และ gateway ครับ ซึ่งเป็น 1 ใน product ของ exzy สำหรับระบบ co-desk ซึ่งผมได้ช่วยดูทราฟฟิกต่างๆ ของ minew ระหว่างการทดสอบ ว่ามีปัญหาอะไรเกิดขึ้นและสามารถแก้ไขได้อย่างไร และยังบันทึกการตั้งค่าทั้งหมดเข้า Obsidian เพื่อให้สามารถนำไปใช้ในอนาคตได้ครับ",
