...
const Culture = () => {
  ...
  const cultureData = [
    ...
    },
    {
      ...
      description: "เป็นการดูระบบการจัดการ minew และ gateway ครับ ซึ่งเป็น 1 ใน product ของ exzy สำหรับระบบ co-desk ซึ่งผมได้ช่วยดูทราฟฟิกต่างๆ ของ minew ระหว่างการทดสอบ ว่ามีปัญหาอะไรเกิดขึ้นและสามารถแก้ไขได้อย่างไร และยังบันทึกการตั้งค่าพื้นฐานของ minew เข้า Obsidian ด้วยครับ",
