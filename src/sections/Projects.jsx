...
const Projects = () => {
  ...
  const projectsData = [
    ...
    {
      id: 4,
      title: "การตรวจสอบสถานะอุปกรณ์ Gateway ",
      description: "อันนี้เป็นส่วนหนึ่งที่พี่เลี้ยงให้ศึกษาครับ เกี่ยวกับการทำงานของ E-ink และ Gateway ที่ตัว gateway จะเป็นตัวเชื่อมระหว่างตัวจอ E-ink ที่เป็นหน้าจอสำหรับการจองที่ติดตามโต๊ะ เข้ากับตัวระบบ ซึ่งก็คือระบบ Co-Desk นั้นเองครับ โดยช่วยตรวจสอบสถานะอุปกรณ์ และจัดทำเอกสารการจัดการหลังบ้านของ Minew ลงใน Obsidian เพื่อใช้เป็นข้อมูลอ้างอิงภายในองค์กร",
      tags: ["Minew", "Gateway"],    
