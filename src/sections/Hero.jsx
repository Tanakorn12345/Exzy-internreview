        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-dark-500/80 max-w-xl mb-10 leading-relaxed">
              ผมชื่อ นายธนกร ทิพย์วารีรัตนะ เป็นนักศึกษาฝึกงานด้าน IT Support ที่ Exzy ในช่วงมิถุนายน - กรกฎาคม 2026 ในบทความนี้ ผมจะแชร์ประสบการณ์การฝึกงานของผมกันครับ
            </p>
