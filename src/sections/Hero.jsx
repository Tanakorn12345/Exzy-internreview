        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-dark-500/80 max-w-xl mb-10 leading-relaxed">
             สวัสดีครับ ผมชื่อ ธนกร ทิพย์วารีรัตนะ นักศึกษาจากคณะเทคโนโลยีสารสนเทศและการสื่อสาร เลือกมาฝึกงานในตำแหน่ง IT Support กับบริษัท Exzy บริษัทผู้พัฒนาโซลูชันด้าน Smart Office และ Smart Workplace ตลอดระยะเวลากว่า 2 เดือน ผมได้เรียนรู้ทั้งการลงหน้างานกับพี่ๆ การติดตั้งและตั้งค่าระบบเบื้องต้น รวมถึงการจัดทำคลังข้อมูล บทความนี้จะพาทุกคนไปดูว่าการฝึกงานที่ Exzy เป็นอย่างไร และผมได้เรียนรู้อะไรจากประสบการณ์ครั้งนี้บ้างครับ
            </p>
