        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-base text-dark-500/80 mb-4 leading-relaxed">
             Exzy (บริษัท เอ็กซ์ซี จำกัด) เป็นผู้พัฒนาโซลูชันด้าน Smart Office และ Smart Workplace ที่มุ่งเน้นการสร้างนวัตกรรมเพื่อยกระดับการทำงานขององค์กรในยุคดิจิทัล โดยนำเทคโนโลยีสมัยใหม่มาผสานกับการออกแบบที่ทันสมัย เพื่อเพิ่มประสิทธิภาพในการบริหารจัดการพื้นที่ทำงานและส่งเสริมประสบการณ์การทำงานที่ดียิ่งขึ้น
            </p>
            <p className="text-base text-dark-500/80 leading-relaxed">
            บริษัทมีผลิตภัณฑ์และโซลูชันที่ครอบคลุมการทำงานภายในองค์กร เช่น Meet in Touch (ระบบจองห้องประชุมอัจฉริยะ), Codesk (ระบบจองโต๊ะทำงาน), Locker Space (ระบบตู้ล็อกเกอร์อัจฉริยะ) รวมถึงระบบและอุปกรณ์อื่น ๆ ที่ช่วยสนับสนุนการทำงานในรูปแบบ Smart Office อย่างครบวงจร
            </p>
          </div>
        </div>
      </div>
